...
>Type: SSH Username with Private Key ID: node-app-key Username: ubuntu Private Key: (Paste PEM key)
...
4.Repository URL:https://github.com/iamSonaliGhuge/python-app-deploy.git
